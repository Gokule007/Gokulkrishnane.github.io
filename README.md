...
Model-Based Development Engineer | Locomotive & EV Systems
...
10th, SSLC: I.K. Kumaran Govt Higher Secondary School |Pandakkal | 68%.	[2012]
...
•	Determined the state-of-charge and range of the vehicle using different drive cycles as well as varying input.
    Battery Modelling of Unagi E250 Electric scooter	
...
•	Prepared budgets by estimating materials, labor and construction costs.
...
•	 In monotonous highway driving situations, the Highway Assistant assists the driver by taking over longitudinal and lateral vehicle guidance. To a certain extent, the partially automated function can start, accelerate, brake, and steer the vehicle. The driver must constantly monitor the system and be prepared to take complete control of the vehicle at any time.
•	Drivers are taught to check their rearview and side mirrors, as well as look over each shoulder, before changing lanes. Even for those who adhere to this checklist, the vehicle's blind spot – the area alongside and just behind the vehicle – is a constant source of danger and is frequently the cause of serious accidents. Vehicles approaching quickly from behind can also be dangerous. This feature was created to make changing lanes safer.
...
•	Introduction to Battery Technology for Electric Vehicles using MATLAB & Simulink. (Skill-Lync)
•	Introduction to Advanced Driver Assistance System using MATLAB & Simulink. (Skill-Lync)
